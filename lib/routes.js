 ...
 */
(function (that) {
    const hasProp = (object, key) => Object.prototype.hasOwnProperty.call(object, key);
    let NodeTypes;
    (function (NodeTypes) {
    ...
    class UtilsClass {
            ...
            switch (this.get_object_type(object)) {
                ...
                default:
                    if (object !== null && object !== undefined) {
                        result.push(encodeURIComponent(prefix) + "=" + encodeURIComponent("" + object));
                    }
            }
            return result.join("&");
        }
        ...
        build_route(parts, required_params, default_options, route, full_url, args) {
            ...
            // console.log({required_params, missing_params, query_parameters});
