(function() {
  ...
  (function(root, factory) {
    ...
    namespace = function(root, namespaceString) {
      ...
      return namespace(root[current], parts.join("."));
    };
    if (typeof define === "function" && define.amd) {
      return define("NAMESPACE", [], function() {
        var _ref;
        namespace(root, "NAMESPACE");
        _ref = factory(root), root.NAMESPACE = _ref[0], root.NAMESPACE.options = _ref[1];
        return root.NAMESPACE;
      });
    } else {
      namespace(root, "NAMESPACE");
      return _ref = factory(root), root.NAMESPACE = _ref[0], root.NAMESPACE.options = _ref[1], _ref;
    }
  })(this, function(root) {
