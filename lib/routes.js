  ...
  Utils = {
    ...
    assign: function() {
      ...
      if (typeof Object.assign === 'function') {
        ...
        return this.assignImplementation.apply(this, [target].concat(slice.call(sources)));
      }
    },
    assignImplementation: function() {
      var index, nextKey, nextSource, sources, target, to;
      target = arguments[0], sources = 2 <= arguments.length ? slice.call(arguments, 1) : [];
