(function() {
  ...
  Utils = {
    ...
    need_trailing_slash: function() {
      return defaults.default_url_options.hasOwnProperty("trailing_slash") && defaults.default_url_options.trailing_slash === true;
    },
    ...
    build_path: function(required_parameters, optional_parts, route, args) {
      ...
      if (this.need_trailing_slash() === true) {
        url = url.replace(/(.*?)[\/]?$/, "$1/");
      }
