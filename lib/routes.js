...
(function() {
  ...
  Utils = {
    ...
    route_url: function(route_defaults) {
      var base_url_js, default_url_options, hostname, port, protocol;
      ...
      port = route_defaults.port || (!route_defaults.host ? default_url_options.port || Utils.current_port_js() : void 0);
      if (port) {
        port = ":" + port;
      }
