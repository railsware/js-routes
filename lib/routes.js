  ...
  Utils = {
    ...
    set_default_url_options: function(optional_parts, options) {
      ...
      for (i = j = 0, len = optional_parts.length; j < len; i = ++j) {
        ...
        if (!options.hasOwnProperty(part) && defaults.default_url_options.hasOwnProperty(part) && defaults.default_url_options[part] !== null) {
    ...
    build_path: function(required_parameters, optional_parts, route, args) {
      ...
      if (cfg.default_url_params) {
        for (var key in cfg.default_url_params) parameters[key] = cfg.default_url_params[key];
      }
