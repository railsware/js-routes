...
(function() {
  ...
  Utils = {
    ...
    normalize_options: function(required_parameters, optional_parts, actual_parameters) {
      ...
      options = this.merge(defaults.default_url_options, options);
      result = {};
      url_parameters = {};
    ...
    build_path: function(required_parameters, optional_parts, route, url_defaults, args) {
      var options, parameters, result, url, url_params;

      args = Array.prototype.slice.call(args);
      options = this.normalize_options(required_parameters, optional_parts, args);
      ...
      if (url_defaults) {
        url = this.route_url(url_defaults) + url;
      }
      return url;
    },
    ...
    route: function(required_parts, optional_parts, route_spec, url_defaults) {
      ...
      path_fn = function() {
        return Utils.build_path(required_parts, optional_parts, route_spec, url_defaults, arguments);
      };
    ...
    route_url: function(route_defaults) {
      var default_url_options, hostname, port, protocol;
      ...
      port = route_defaults.port || (!route_defaults.host ? default_url_options.port || Utils.current_port() : void 0);
      port = port ? ":" + port : '';
